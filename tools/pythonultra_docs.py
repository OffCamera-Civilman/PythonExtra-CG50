...
def build(root, output, allow_missing=False, revision=None):
...
Runtime help()/__doc__ improvements are tracked separately in the master list;
the downloadable reference does not imply those runtime changes have landed.
